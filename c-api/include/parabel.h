...
typedef struct ParabelDataSet ParabelDataSet;

typedef struct ParabelModel ParabelModel;

typedef struct ParabelTrainer ParabelTrainer;
 ...
 */
int8_t parabel_init_logger(void);
